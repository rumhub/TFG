...
int main()
{
    ...
    // Mostrar tiempo
    cout << "Tiempo CPU: " << duration.count() << " (ms)" << endl;
    ...
    // Mostrar resultado
    cout << "Tiempo GPU método simple: " << duration.count() << " (ms)" << endl;
    ...
    // Mostrar tiempo
    cout << "Tiempo GPU método memoria compartida para coalescencia: " << duration.count() << " (ms)" << endl;
    ...
    // Mostrar tiempo
    cout << "Tiempo GPU método de multiplicación compartida: " << duration.count() << " (ms)" << endl;

    // Comprobar resultados
    if(comprobarResultados(h_C_gpu_1, h_C_gpu_2, M, N) && comprobarResultados(h_C_gpu_1, h_C_gpu_3, M, N))
