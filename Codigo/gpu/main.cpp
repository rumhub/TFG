...
int main()
{
    ...
    train_imgs_ptr = (float *)malloc(tam_img * n_imgs * n_clases * sizeof(float));
    train_labels_ptr = (float *)malloc(n_imgs*n_clases * n_clases * sizeof(float));
    test_imgs_ptr = (float *)malloc(tam_img * n_imgs * n_clases * sizeof(float));
    test_labels_ptr = (float *)malloc(n_imgs*n_clases * n_clases * sizeof(float));
    ...
    CNN cnn(capas_conv, n_capas_conv, capas_pool, padding, capas_fully, n_capas_fully, C, H, W, lr, n_imgs, mini_batch);
    ...
    leer_imagenes_cifar10_ptr(train_imgs_ptr, train_labels_ptr, test_imgs_ptr, test_labels_ptr, padding[0], n_imgs, n_imgs, n_clases);
    //leer_imagenes_10_big_cats(train_imgs_ptr, train_labels_ptr, test_imgs_ptr, test_labels_ptr, padding[0], n_imgs, n_imgs, n_clases);
    cnn.set_train(train_imgs_ptr, train_labels_ptr, test_imgs_ptr, test_labels_ptr, n_imgs, n_clases, C, H, W);
    // cnn.set_test(test_imgs_ptr, test_labels_ptr, n_imgs_train, n_clases, C, H, W);
