...
\input{capitulos/03\_Aportaciones}
\input{capitulos/04\_Adaptacion\_GPU}
\input{capitulos/05\_Plataformas}
\input{capitulos/06\_Conclusiones}

\appendix
\input{apendices/funciones_cuDNN}
\input{apendices/planificacion}
\input{apendices/backprop_softmax}
\input{apendices/backprop_fully}
\input{apendices/backprop_conv}
