...
Se caracterizada por, en cada época, dividir el conjunto de entrenamiento en varios subconjuntos aleatorios y disjuntos entre ellos (mini-batch), de tal forma que se calcule el gradiente y actualicen los parámetros del modelo en cada uno de ellos.\\ Además, tal y como se explicará posteriormente, al ser cada subconjunto independiente al resto, es un proceso con gran potencial para paralelización. \cite{sgd_stocastico}
